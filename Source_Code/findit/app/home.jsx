...
const Home = () => {
  ...
  const handleUploadFound=async(event)=>{
    ...
    try {
      ...
      setImageUrl('https://cloud.appwrite.io/console/project-665df1ef0031b59f137e/storage/bucket-668a965e003a0df0cf74/file-668b9f9f000b08dd2e83')
  ...
  useEffect(() => {
    ...
    getItems();
      ...
      const handleSearchMissingItem = async () => {
        ...
        console.log('TARGETTING: ',targets)
        const imageurls = [];
